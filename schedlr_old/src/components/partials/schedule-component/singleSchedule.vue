<template>
    <div class="t-overflow-auto mt-3" >
        <div class="t-grid t-grid-cols-7 t-gap-2 t-bg-logoBlue t-h-[50px] p-2" >
            <div class="t-overflow-hidden t-flex t-items-center" >
                <h6 class="t-truncate t-font-semibold t-text-white " title="Time" >Time</h6>
            </div>
            <div class="t-overflow-hidden t-flex t-items-center" >
                <h6 class="t-truncate t-font-semibold t-text-white" title="tueday" >Monday</h6>
            </div>
            <div class="t-overflow-hidden t-flex t-items-center" >
        ...
        <div  v-for="(schedule,index) in schedules" :key="index" class="t-grid t-grid-cols-7 t-h-[30px] odd:t-bg-white even:t-bg-slate-100" >
            ...
            <div class=" t-h-full t-w-full" >
                ...
                <div class="t-h-full t-w-full" v-else >
                    <div class=" t-w-full t-h-full pt-2 bg-success"   v-if="index === 0 || schedule.mon.id  !== schedules[index - 1].mon.id" >
                        <div class="" >
                            <h6 class="t-p-1 t-text-white t-truncate text-uppercase t-text-center t-text-[12px] " :title="schedule.mon.professor" >{{ schedule.mon.professor }}</h6>
                        </div>
                    </div>
                    <div class="t-h-full t-w-full t-overflow-hidden t-flex t-items-center" >
                        ...
                        <div class="bg-success t-h-full t-w-full t-relative " v-else >
                            ...
                            <div  class="t-w-full t-h-full bg-success" v-else-if=" index >= 2 &&  schedule.mon.id === schedules[index - 2].mon.id &&  schedule.mon.professor === schedules[index - 2].mon.professor " >
                                <h6 class=" t-text-white t-truncate text-uppercase t-text-center t-text-[12px]" :title="schedule.mon.section+'-'+schedule.mon.room" >{{schedule.mon.section}} , {{ schedule.mon.room }}</h6>
                            </div>
                            <div class="bg-success t-max-h-full t-overflow-hidden" v-else-if=" index >= 1 &&  schedule.mon.id === schedules[index - 1].mon.id &&  schedule.mon.professor === schedules[index - 1].mon.professor " >
                                <h6 class=" t-text-white t-truncate text-uppercase t-text-center t-text-[12px]" :title="schedule.mon.subject" >{{ schedule.mon.subject }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class=" t-h-full t-w-full" >
                ...
                <div class="t-h-full t-w-full" v-else >
                    <div class=" t-w-full t-h-full pt-2 bg-success"   v-if="index === 0 || schedule.tue.id  !== schedules[index - 1].tue.id" >
                        <div class="" >
                            <h6 class="t-p-1 t-text-white t-truncate text-uppercase t-text-center t-text-[12px] " :title="schedule.tue.professor" >{{ schedule.tue.professor }}</h6>
                        </div>
                    </div>
                    <div class="t-h-full t-w-full t-overflow-hidden t-flex t-items-center" >
                        ...
                        <div class="bg-success t-h-full t-w-full t-relative " v-else >
                            ...
                            <div  class="t-w-full t-h-full bg-success" v-else-if=" index >= 2 &&  schedule.tue.id === schedules[index - 2].tue.id &&  schedule.tue.professor === schedules[index - 2].tue.professor " >
                                <h6 class=" t-text-white t-truncate text-uppercase t-text-center t-text-[12px]" :title="schedule.tue.section+'-'+schedule.tue.room" >{{schedule.tue.section}} , {{ schedule.tue.room }}</h6>
                            </div>
                            <div class="bg-success t-max-h-full t-overflow-hidden" v-else-if=" index >= 1 &&  schedule.tue.id === schedules[index - 1].tue.id &&  schedule.tue.professor === schedules[index - 1].tue.professor " >
                                <h6 class=" t-text-white t-truncate text-uppercase t-text-center t-text-[12px]" :title="schedule.tue.subject" >{{ schedule.tue.subject }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class=" t-h-full t-w-full" >
                ...
                <div class="t-h-full t-w-full" v-else >
                    <div class=" t-w-full t-h-full pt-2 bg-success"   v-if="index === 0 || schedule.wed.id  !== schedules[index - 1].wed.id" >
                        <div class="" >
                            <h6 class="t-p-1 t-text-white t-truncate text-uppercase t-text-center t-text-[12px] " :title="schedule.wed.professor" >{{ schedule.wed.professor }}</h6>
                        </div>
                    </div>
                    <div class="t-h-full t-w-full t-overflow-hidden t-flex t-items-center" >
                        ...
                        <div class="bg-success t-h-full t-w-full t-relative " v-else >
                            ...
                            <div  class="t-w-full t-h-full bg-success" v-else-if=" index >= 2 &&  schedule.wed.id === schedules[index - 2].wed.id &&  schedule.wed.professor === schedules[index - 2].wed.professor " >
                                <h6 class=" t-text-white t-truncate text-uppercase t-text-center t-text-[12px]" :title="schedule.wed.section+'-'+schedule.wed.room" >{{schedule.wed.section}} , {{ schedule.wed.room }}</h6>
                            </div>
                            <div class="bg-success t-max-h-full t-overflow-hidden" v-else-if=" index >= 1 &&  schedule.wed.id === schedules[index - 1].wed.id &&  schedule.wed.professor === schedules[index - 1].wed.professor " >
                                <h6 class=" t-text-white t-truncate text-uppercase t-text-center t-text-[12px]" :title="schedule.wed.subject" >{{ schedule.wed.subject }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class=" t-h-full t-w-full" >
                ...
                <div class="t-h-full t-w-full" v-else >
                    <div class=" t-w-full t-h-full pt-2 bg-success"   v-if="index === 0 || schedule.thu.id  !== schedules[index - 1].thu.id" >
                        <div class="" >
                            <h6 class="t-p-1 t-text-white t-truncate text-uppercase t-text-center t-text-[12px] " :title="schedule.thu.professor" >{{ schedule.thu.professor }}</h6>
                        </div>
                    </div>
                    <div class="t-h-full t-w-full t-overflow-hidden t-flex t-items-center" >
                        ...
                        <div class="bg-success t-h-full t-w-full t-relative " v-else >
                            ...
                            <div  class="t-w-full t-h-full bg-success" v-else-if=" index >= 2 &&  schedule.thu.id === schedules[index - 2].thu.id &&  schedule.thu.professor === schedules[index - 2].thu.professor " >
                                <h6 class=" t-text-white t-truncate text-uppercase t-text-center t-text-[12px]" :title="schedule.thu.section+'-'+schedule.thu.room" >{{schedule.thu.section}} , {{ schedule.thu.room }}</h6>
                            </div>
                            <div class="bg-success t-max-h-full t-overflow-hidden" v-else-if=" index >= 1 &&  schedule.thu.id === schedules[index - 1].thu.id &&  schedule.thu.professor === schedules[index - 1].thu.professor " >
                                <h6 class=" t-text-white t-truncate text-uppercase t-text-center t-text-[12px]" :title="schedule.thu.subject" >{{ schedule.thu.subject }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class=" t-h-full t-w-full" >
                ...
                <div class="t-h-full t-w-full" v-else >
                    <div class=" t-w-full t-h-full pt-2 bg-success"   v-if="index === 0 || schedule.fri.id  !== schedules[index - 1].fri.id" >
                        <div class="" >
                            <h6 class="t-p-1 t-text-white t-truncate text-uppercase t-text-center t-text-[12px] " :title="schedule.fri.professor" >{{ schedule.fri.professor }}</h6>
                        </div>
                    </div>
                    <div class="t-h-full t-w-full t-overflow-hidden t-flex t-items-center" >
                        ...
                        <div class="bg-success t-h-full t-w-full t-relative " v-else >
                            ...
                            <div  class="t-w-full t-h-full bg-success" v-else-if=" index >= 2 &&  schedule.fri.id === schedules[index - 2].fri.id &&  schedule.fri.professor === schedules[index - 2].fri.professor " >
                                <h6 class=" t-text-white t-truncate text-uppercase t-text-center t-text-[12px]" :title="schedule.fri.section+'-'+schedule.fri.room" >{{schedule.fri.section}} , {{ schedule.fri.room }}</h6>
                            </div>
                            <div class="bg-success t-max-h-full t-overflow-hidden" v-else-if=" index >= 1 &&  schedule.fri.id === schedules[index - 1].fri.id &&  schedule.fri.professor === schedules[index - 1].fri.professor " >
                                <h6 class=" t-text-white t-truncate text-uppercase t-text-center t-text-[12px]" :title="schedule.fri.subject" >{{ schedule.fri.subject }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class=" t-h-full t-w-full" >
                ...
                <div class="t-h-full t-w-full" v-else >
                    <div class=" t-w-full t-h-full pt-2 bg-success"   v-if="index === 0 || schedule.sat.id  !== schedules[index - 1].sat.id" >
                        <div class="" >
                            <h6 class="t-p-1 t-text-white t-truncate text-uppercase t-text-center t-text-[12px] " :title="schedule.sat.professor" >{{ schedule.sat.professor }}</h6>
                        </div>
                    </div>
                    <div class="t-h-full t-w-full t-overflow-hidden t-flex t-items-center" >
                        ...
                        <div class="bg-success t-h-full t-w-full t-relative " v-else >
                            ...
                            <div  class="t-w-full t-h-full bg-success" v-else-if=" index >= 2 &&  schedule.sat.id === schedules[index - 2].sat.id &&  schedule.sat.professor === schedules[index - 2].sat.professor " >
                                <h6 class=" t-text-white t-truncate text-uppercase t-text-center t-text-[12px]" :title="schedule.sat.section+'-'+schedule.sat.room" >{{schedule.sat.section}} , {{ schedule.sat.room }}</h6>
                            </div>
                            <div class="bg-success t-max-h-full t-overflow-hidden" v-else-if=" index >= 1 &&  schedule.sat.id === schedules[index - 1].sat.id &&  schedule.sat.professor === schedules[index - 1].sat.professor " >
                                <h6 class=" t-text-white t-truncate text-uppercase t-text-center t-text-[12px]" :title="schedule.sat.subject" >{{ schedule.sat.subject }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
